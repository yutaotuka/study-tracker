...
export const PLAN = {
  ...
  "weeks": [
    ...
    },
    {
      ...
      "js": "―",
      "cc": "―",
      "other": "Vercel公開・READMEと想定Q&A（参画直前）"
    }
  ],
  "steps": [
    {
  ...
  "rules": [
    {
      ...
      "body": "コア65hは、参画時に「Next.jsへコンバートした経験がある」状態を作るための最短経路。余力22h（Claude Code講座・振り返りの一部・TS応用）は、コアが予定どおり進んだときだけ手を付ける。迷ったらコアを優先し、余力枠は落とす。"
    },
    {
      "no": "2",
      "title": "8/23までの3週間でTS/Reactに0hだった。同じ配分に戻さない",
      "body": "JS基礎に21.2h使い、案件の必須スキルに一度も触れなかったのが今回の組み直しの理由。JS基礎は2週目のCh13で打ち切る。3週目以降にJSへ戻るのは、Reactで必要になった時だけにする。"
    },
    {
      "no": "3",
      "title": "課題は必ず自分で書いてからAIに見せる",
      "body": "最初からAIに書かせない。自分で書いて詰まって、書き終わってからレビューさせる。案件の必須スキルは「AI駆動での開発経験」だが、AIの出力を評価できないと駆動にならない。"
    },
    {
      "no": "4",
      "title": "5週目のコンバートが本命",
      "body": "案件の推奨スキルが「アーキテクチャコンバートの経験」。4週目までに小さくてもいいので動くReactアプリを完成させ、5週目にNext.jsへ移す。移せる状態を作ることを優先する。"
    },
    {
      "no": "5",
    ...
    },
    {
      ...
      "body": "8/7〜8/23の17日のうち、記録があったのは10日だった。記録が無いと、遅れているのか記録漏れなのかが区別できず、手当てが遅れる。書くことが無い日は時間だけ入れればよい。"
    },
    {
      "no": "10",
      "title": "9/30に全部終わらなくてよい。コアが終わっていれば成功",
      "body": "参画後もキャッチアップは続く。完璧に終わらせることより、参画時点でReactとNext.jsを自分の手で書いた経験があることを優先する。"
    }
  ],
  "references": [
    {
